...
function Secondinning() {
    ...
    const {targetscore, batfirst,batsecond}=location.state || {}
    ...
    const[inpname, setinpname]= useState('')
     ...
     { isstriker? setstrikerball(prev => prev +1):setnonstrikerball(prev=> prev +1)}
      ...
      <p className='text-gray-600'>Scorecard :{batsecond}</p>
        { okstriker && (<>
        <input
    ...
    <div className='border-1 bg-orange-100 inline-block px-2 py-1 mx-2 my-2 w-full'>
     ...
     {striker !== '' && (<>
       ...
       <div className='  border-1 bg-green-100 my-2 w-full px-2 py-1 mx-2 '>
         ...
         <p className='mx-2 mt-3 mb-2'>Totalscore:{totalscore}-{wicket}</p> 
         <p className='mx-2 my-2'> target -{targetscore}</p>

    <div className='border-1 bg-blue-200 px-2 mx-2 my-2 py-2'>
             <p>Bowling figures({batfirst}):</p>
